...
fun Project115(navController: NavController) {
    Column(modifier = Modifier.padding(20.dp)) {
        Text(
            text = "Project 115: Enter a name and a mark for 2 students.",
    ...
    Column(
        ...
        val studentsList = remember { mutableListOf<Student2>() }
        ...
        Button(
            onClick = {
                outcome=""
                if(numbers <=2){
                    studentsList.add(Student2(studentName, studentMark.toInt()))
                    numbers++
                }
...
class Student2 (val name:String, val mark: Int){
