...
@Composable
fun Project41(navController: NavController) {
    Column(modifier = Modifier.padding(20.dp)) {
        Text(
            text = "Project 41: Introduce the amount of numbers you want to enter and the value of each one.", textAlign = TextAlign.Center, color = Color.Green,
    ...
    Column(
        ...
        Row(
            ...
            Button(
                onClick = {
                    navController.navigate("ogueta-project40")
                },
                modifier = Modifier
                    .padding(8.dp)
                    .weight(1f)
