...
@Composable
fun Project61(navController: NavController) {
    Column(modifier = Modifier.padding(20.dp)) {
        Text(
            text = "Project 61: Introduce the weight of the pieces. When you're finished, enter 0.",
    ...
    Column(
        ...
        Button(
            onClick = {
                ...
                if (numValue.toDouble() != 0.0) {
                    ...
                    when {
                        numValue.toDouble() < 9.8 ->
                            weightLower98++

                        numValue.toDouble() >= 9.8 && numValue.toDouble() <= 10.2 ->
                            weight98to102++
        ...
        Row(
            ...
            Button(
                onClick = {
                    navController.navigate("ogueta-project62")
                },
                modifier = Modifier
                    .padding(8.dp)
                    .weight(1f)
