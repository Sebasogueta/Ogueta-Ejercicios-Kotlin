...
fun Project169(navController: NavController) {
    Column(modifier = Modifier.padding(20.dp)) {
        Text(
            text = "Project 169: Enter a document number to check if it is enrolled in the course",
    ...
    Column(
        ...
        Button(
            onClick = {
                val course1 = Course()
                outcome = if (document.toInt() in course1)
...
data class Student1(val document: Int, val name: String)

class Course {
    val students = arrayOf(
        Student1(123456, "Marcos"),
        Student1(666666, "Ana"),
        Student1(777777, "Luis")
    )
