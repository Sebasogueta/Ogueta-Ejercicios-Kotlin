...
@Composable
fun Project65(navController: NavController) {
    Column(modifier = Modifier.padding(20.dp)) {
        Text(
            text = "Project 65: Introduce the amount of triangles and the value of each of their sides.", textAlign = TextAlign.Center, color = Color.Green,
    ...
    Column(
        ...
        Row(
            ...
            Button(
                onClick = {
                    navController.navigate("ogueta-project66")
                },
                modifier = Modifier
                    .padding(8.dp)
                    .weight(1f)
